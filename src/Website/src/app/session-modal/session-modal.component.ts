...
export class SessionModalComponent implements OnInit {
  ...
  public importRooms() {
    if (confirm('Do you really want to import the rooms of the selected session? All rooms in the current session will be deleted.')) {
      this.sessionService.currentSession.rooms = this.selectedSession.rooms;
  ...
  public importSlots() {
    if (confirm('Do you really want to import the slots of the selected session? All slots in the current session will be deleted.')) {
      this.sessionService.currentSession.slots = this.selectedSession.slots;
