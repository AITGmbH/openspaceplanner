...
export class SessionTopicBoxComponent implements OnInit {
    ...
    public hasRoomSeatsConflict() {
        ...
        const room = _.find(this.sessionService.currentSession.rooms, {
            id: this.topic.roomId,
        });
        if (room == null) {
            return false;
        }
    ...
    public hasSameOwnerSlotConflict() {
        ...
        const topics = _.filter(this.sessionService.currentSession.topics, {
            slotId: this.topic.slotId,
